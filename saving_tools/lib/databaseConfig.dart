...
class databaseConfig {
  ...
  Future<Database> initDatabase() async {
    ...
    onCreate: (db, version) {
      ...
      db.execute("CREATE TABLE Goal(id INTEGER PRIMARY KEY, description TEXT, date TEXT, percent REAL, amount REAL, distributionPercentage REAL, rank INTEGER, isCompleted BOOL, isExpired BOOL, user_id INTEGER NOT NULL DEFAULT 0)");
